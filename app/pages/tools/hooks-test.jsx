...
import {utils,Link} from '@common';

import useStateFromProps from '@common/use/useStateFromProps';
import useUpdate from '@common/use/useUpdate';
import usePrevious from '@common/use/usePrevious';

import cancelablePromise from '@common/utils/cancelablePromise';

import configs from '@app/configs';
import routers from '@app/router/setting';

const generateId=require('./test');
console.log(11,generateId);
